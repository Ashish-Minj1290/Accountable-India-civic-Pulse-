...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, activeTab, onTabChange, onClose, language }) => {
  ...
  const navItems: NavItem[] = [
    ...
    { id: 'legal', label: t.legalWatch, icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg> },
  ...
  return (
    <>
      {/* Mobile Overlay */}
      {isOpen && (
        <div className="fixed inset-0 bg-slate-900/50 z-[60] lg:hidden" onClick={onClose} />
      )}

      <aside className={`
        fixed inset-y-0 left-0 z-[70] w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 transition-transform duration-300 transform
      ...
      `}>
        <div className="h-full flex flex-col p-6">
          ...
          <div className="flex items-center gap-3 mb-10 px-2">
            <div className="w-10 h-8 flex items-center justify-center rounded-lg bg-orange-500 overflow-hidden">
              <img 
            ...
            <span className="font-black text-slate-900 dark:text-white tracking-tight">Accountable IN</span>
          </div>
              ...
              <button
                ...
                className={`
                  ...
                  ${activeTab === item.id 
                    ...
                    : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-orange-600 font-medium'}
                `}
              >
